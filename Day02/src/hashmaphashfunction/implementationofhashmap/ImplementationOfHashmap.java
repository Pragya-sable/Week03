...
// implementation a basic hash map class with operations for insertion,
...
public class ImplementationOfHashmap {
    ...
    static class HashMap<K,V>{
      ...
      // @SuppressWarnings("unchecked")
        ...
        // it is used when the value of lamda is greater than constant value
        ...
        // Method to add key and value inside hash map
